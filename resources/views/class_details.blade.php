        ...
        <div class="card bg-light border-0">
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">is fulled:</span>{{ $class['is_fulled'] == "1" ? "yes" : "No" }}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="text-md-end">
                <a href="{{route('class.store')}}" class="btn mt-4 btn-primary text-white fs-5 fw-bold border-0 py-2 px-md-5">
                  Back to All classes
                </a>
              </div>
            </div>
